<?php include("../../include/tinclude.php"); ?>
<!DOCTYPE html>
        ...
        <div id="main-containt-wrapper">
            <div id="main-containt">
                <div class="page-title">
                    <div class="views float-l"><p>Payment Failed! </p></div>
                </div>
                <div id="messages">
                ...
                <div id="left-col">
                    <div class="containt-block">
                        <div class="sub-title"><h3>Sorry!</h3></div>

                        <div class="price">Your payment was failed. Try agin..</div>
                    </div>
                </div>
