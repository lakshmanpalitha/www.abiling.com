...
if ($en->decode($read->get("id1")) == 1) {
    $ob1 = $pay->msgmanual();
} else if ($en->decode($read->get("id1")) == 2) {
   $ob1 = $pay->msgpaypal();
} else if ($en->decode($read->get("id1")) == 3) {
    $ob1 = $pay->msgonline();
} else if ($en->decode($read->get("id1")) == 4) {
    $ob1 = $pay->msgfail();
}
?>
<!DOCTYPE html>
        ...
        <div id="main-containt-wrapper">
            <div id="main-containt">
                <div class="page-title">
                    <div class="views float-l"><p>Payment Success </p></div>
                </div>
                <div id="messages">
                    <?php
                    $ob = $er->displayerror();
                ...
                <div id="left-col">
                    <div class="containt-block">
                        <div class="sub-title"><h3><?php if ($ob)
                        echo $ob1['title'] ?></h3></div>

                        <div class="price"><?php if ($ob)
                                echo $ob1['msg'] ?></div>
                    </div>
                </div>
