                        ...
                        <form method="post" action="login.php" id="login_form" >
                            <div class="containt">
                                <div class="input-block">
                                    ...
                                    <input  class="validate[required]" name="fields_req[user_name]" type="text">
                                </div>
                                <div class="input-block">
                                    <label>password*:</label>
                                    <input  class="validate[required]" name="fields_req[password]" id="password" type="password">
                                </div>
                                
                                <div class="input-block fpass_link">
                                <a class="fpass_link"  href="forgot_password.php"> Forgot My password / Login Name?</a> </div>
                                <div class="submit-block">
                                    <input class="green" name="login" type="submit" value="LOGIN">
                                </div>
                            </div>
                        </form>
                    </div>
