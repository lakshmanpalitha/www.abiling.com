...
if (!$read->get("crPayment", "POST")) {
    $pr->redirect("payment.php");
}
if (!$ob=$pay->setPayment()) {
    $pr->redirect("payment.php");
}
?>
<!DOCTYPE html>
            ...
            <div id="main-containt">
                ...
                <div id="left-col">
                    <div class="containt-block">
                        <div class="sub-title"><h3><?php if($ob) echo $ob['title'] ?></h3></div>

                        <div class="price"><?php if($ob) echo $ob['msg'] ?></div>
                    </div>
                </div>
