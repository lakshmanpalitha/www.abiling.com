...
<html lang="en">
    ...
    <body>
        ...
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav">
                <li class="" ><a title="" href="#"><i class="icon icon-user"></i> <span class="text"><?php echo $pr->getSession("user"); ?></span></a></li>
        ...
        <div id="content">
            ...
            <div  class="quick-actions_homepage">
                <ul class="quick-actions">
                    ...
                    <li> <a href="blast_ad.php?id1=info"> <i class="icon-shopping-bag"></i>Create Info Ads</a> </li>
                     <li> <a href="blast_ad.php?id1=url"> <i class="icon-shopping-bag"></i>Create Url Ads</a> </li>
                    <li> <a href="blasted_ad.php"> <i class="icon-database"></i>Blast Ads</a> </li>
                    <li> <a href="manageads.php"> <i class="icon-web"></i>Pending Ads</a> </li>
                    <li> <a href="members.php"> <i class="icon-people"></i>Members</a> </li>
                    <li> <a href="advertisers.php"> <i class="icon-calendar"></i>Advertisers</a> </li>
