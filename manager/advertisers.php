...
<!--        <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th-list"></i> Tables</a>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Advertisers</a> </div>
                <h1>Advertisers</h1>
            </div>
                                            ...
                                            foreach ($mem as $m) {
                                                ...
                                                <tr <?php echo $style ?> class="gradeX">
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <a class="tip-top" data-original-title="Payments" href="apayments.php?id1=<?php echo $m->account_id ?>"><i class="icon-shopping-cart"></i></a>&nbsp &nbsp
                                                        <a class="tip-top" data-original-title="More Detail" href=""><i class="icon-search"></i></a>&nbsp &nbsp
                                                        <a class="tip-top" data-original-title="Block Ad" href="advertisers.php?id2=block&id1=<?php echo $m->account_id ?>"><i class="icon-off"></i></a>&nbsp &nbsp                                           
                                                        <a class="tip-top" data-original-title="Delete Ad" onclick='return getConfirmation();' href="advertisers.php?id2=del&id1=<?php echo $m->account_id ?>"><i class="icon-remove"></i></a>
